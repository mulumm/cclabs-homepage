          ...
          <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-8 mt-20 text-center md:text-left">
            <div className="max-w-4xl animate-fade-in-up">
              ...
              <p className="text-xl md:text-2xl font-light text-gray-300 mb-10 leading-relaxed max-w-2xl">
                Our lab conducts research across diverse areas of computer science, Bio-AI, Computer Vision, and Data Analysis,<br className="hidden md:block"/>with the goal of developing practical AI technologies.
              </p>
            </div>
          </div>
